...
<html>
	<head>
		...
		<title>Celebrities | Divine Event Management</title>	
...
#widthchange.nonopenmenu{width:0px !important;overflow:hidden}																				
		...
		.main-image-header{background-image:url('../../images/celebrities_banner.jpeg') !important;}		
		.service-block>div>img{width: 100%;height:20vh;padding: 0 !important;}	
    ...
    background: white;
    padding: 2% 3%;}
.service-block>div>img{width: 100%;height:40vh !important;padding: 0 !important;}		
		}
		@media only screen and (min-width: 1201px) {
		.main-image-header{height: 426px !important;}
#demo{    width: 19%;
    text-align: left;
    position: absolute;
    background: white;
		...
		<div class="col-xs-12 col-md-12 cols-sm-12 col-lg-12 menu-div">
			<div class="row">
				<div class="col-xs-6 col-md-6 cols-sm-6 col-lg-6">
					<a href="../../ar"><img src="../../images/logo.png" class="logo_image" alt="event management company logo"></a>
				</div>
				<div class="col-xs-6 col-md-6 cols-sm-6 col-lg-6 menudiv">
					<label for="show-menu" class="show-menu"><i class="fa fa-bars fa-2x" onclick="changewidth();"></i></label>
					<input type="checkbox" id="show-menu" role="button">
					<!--<div class="nav-wrapper" style="inline-block">
						<div class="sl-nav">
							<button type="button" style="color:white;border: 1px solid white;" class="btn language_button" data-toggle="collapse" data-target="#demo">Ar</button>
						<div id="demo" class="collapse">
							
									<div class="triangle"></div>
									<div  style="text-align:center">
										<span class="active" style="color:black" >Arabic</span><br><br>
										<span onclick="location.href='../../celebrities/en'" style="color:black;cursor:pointer">English</span>
									</div> 
											...
											&nbsp;&nbsp;-->
											<ul id="menu" class="onepress-menu" style="display:inline-block;font-family: 'Tajawal', sans-serif;">
												<li><a href="../../ar" style="font-family: 'Tajawal', sans-serif;">الصفحة الرئيسية</a></li>
												<li><a href="../../services/ar" style="font-family: 'Tajawal', sans-serif;">خدمات</a></li>
												<li><a href="../../celebrities/ar" style="font-family: 'Tajawal', sans-serif;">مشاهير</a></li>
												<li>&nbsp;&nbsp;&nbsp;
<div class="nav-wrapper">
						<div class="sl-nav">
						<span onclick="location.href='../../celebrities/en'" style="color:white;cursor:pointer;border-left:2px solid white" class="btn language_button" >En</span>
							<span onclick="location.href='../../celebrities/ar'" style="color:white; cursor:pointer;font-family: 'Tajawal', sans-serif;" class="btn language_button" >عربى</span>
							<!--<button type="button" style="color:white;border: 1px solid white;" class="btn language_button" data-toggle="collapse" data-target="#demo">En</button>
							<div id="demo" class="collapse">
	   
								<div class="triangle"></div>
								<div style="text-align:center">
									<span onclick="location.href='../ar'" style="color:black;cursor:pointer" >Arabic</span><br><br>
									<span class="active" style="color:black">English</span>
								</div> 
...
<li style="float:none">
						...
						<div class="sl-nav">&nbsp;&nbsp;&nbsp;
						<span onclick="location.href='../../celebrities/en'" style="color:white;cursor:pointer;border-left:2px solid white" class="btn language_button" >En</span>
							<span onclick="location.href='../../celebrities/ar'" style="color:white; cursor:pointer;" class="btn language_button" >Ar</span>
							<!--<button type="button" style="color:white;border: 1px solid white;" class="btn language_button" data-toggle="collapse" data-target="#demo">En</button>
							<div id="demo" class="collapse">
	...
	<div class="main-image-header"></div>
				...
				<div class="col-xs-12 col-md-12 cols-sm-12 col-lg-12" style="padding-bottom: 0%;">
					<div class="container">
						<div class="row" >
							<div class="col-xs-6 col-md-3 cols-sm-3 col-lg-3 service-block"><div class="celebrities_inner"><img style="border-radius: 15px;" src="../../images/celebrities/1.jpg"></div></div>				
							<div class="col-xs-6 col-md-3 cols-sm-3 col-lg-3 service-block"><div class="celebrities_inner"><img style="border-radius: 15px;" src="../../images/celebrities/2.jpg"></div></div>				
							<div class="col-xs-6 col-md-3 cols-sm-3 col-lg-3 service-block"><div class="celebrities_inner"><img style="border-radius: 15px;" src="../../images/celebrities/3.jpg"></div></div>				
							<div class="col-xs-6 col-md-3 cols-sm-3 col-lg-3 service-block"><div class="celebrities_inner"><img style="border-radius: 15px;" src="../../images/celebrities/4.jpg"></div></div>				
							<div class="col-xs-6 col-md-3 cols-sm-3 col-lg-3 service-block"><div class="celebrities_inner"><img style="border-radius: 15px;" src="../../images/celebrities/5.jpg"></div></div>				
							<div class="col-xs-6 col-md-3 cols-sm-3 col-lg-3 service-block"><div class="celebrities_inner"><img style="border-radius: 15px;" src="../../images/celebrities/6.jpg"></div></div>				
							<div class="col-xs-6 col-md-3 cols-sm-3 col-lg-3 service-block"><div class="celebrities_inner"><img style="border-radius: 15px;" src="../../images/celebrities/7.jpg"></div></div>				
							<div class="col-xs-6 col-md-3 cols-sm-3 col-lg-3 service-block"><div class="celebrities_inner"><img style="border-radius: 15px;" src="../../images/celebrities/8.jpg"></div></div>				
						</div>
					</div>
</div>
				</section>
...
{
	$('.menu-div').css("background","-webkit-linear-gradient(rgba(0, 0, 0, 0), rgba(0, 0, 0, 0))");
	/*$('.language_button').css("color","black");
	$('.language_button').css("border","1px solid black");
	$('.menu-div').css("border-bottom","3px solid #facac7");*/
	$('.onepress-menu').css("display","inline-block");
	$('#menubutton').css("display","none");
//	$('.menudiv').css("text-align","left");
}
else
{
	$('.menu-div').css("background","none");
	/*$('.language_button').css("color","white");
	$('.language_button').css("border","1px solid white");*/
	$('.menu-div').css("border-bottom","none");
	//$('.onepress-menu').css("display","none");
	$('#menubutton').css("display","inline-block");
	//$('.menudiv').css("text-align","right");
}
});	
